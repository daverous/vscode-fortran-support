...
export const varibleDecRegEx = /^(([a-zA-Z]{1,})(\((kind=)*([a-zA-Z0-9]{1,})\))?(\s*,\s*[a-zA-Z0-9]{1,}(\(.*\))?)*)\s*::(\s*([a-zA-Z_][a-zA-Z0-9_]{1,})(,\s*([a-zA-Z0-9_]*))*)/ig;
